...
const thisDirName: string = path.dirname(__filename);
...
//----------------------------------------------------------------------------------------------------------------
async function clone_Files_Of_A_Directory_As_Empty_Files(
	src_Dir_Path: fs.PathLike,
	dist_Dir_Path: string,
	the_NewFiles_Type_With_The_Dote: string
) {
	let arr_FilesNames_Without_FileType: String[] = [];
	...
	try {
		...
		for (let file_Name of arr_FilesNames_Without_FileType) {
			...
			console.log(
				`the_Current_File_Name_With_Its_Type = ${the_Current_File_Name_With_Its_Type}`
			);
			console.log(
				`the_Current_File_Name_With_Its_Type = ${the_Current_File_Name_With_Its_Type}`
			);
			const path_OfThe_Current_FileName = path.join(
				dist_Dir_Path,
				the_Current_File_Name_With_Its_Type
			);
